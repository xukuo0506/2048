...
window.onload = function() {
    ...
    if (game.state == game.RUNNING) {
        ...
        var gridPanel = document.querySelector('#gridPanel');

        myTouch.swiper(gridPanel, 'left', function() {
            game.moveLeft();
        });
        myTouch.swiper(gridPanel, 'right: ', function() {
            game.moveRight();
        });
        myTouch.swiper(gridPanel, 'top', function() {
            game.moveUp();
        });
        myTouch.swiper(gridPanel, 'bottom', function() {
            game.moveDown();
        });
